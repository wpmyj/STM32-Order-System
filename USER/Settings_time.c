...
{
	LCD_DrawRecFill((t.St_x+y*(t.Weight+t.Jx_x)), (t.St_y+x*(t.Hight+t.Jx_y)), (t.St_x+y*(t.Weight+t.Jx_x)+t.Weight), (t.St_y+x*(t.Hight+t.Jx_y)+t.Hight),color);
...
void Settings_Time_Func(void)
{
	...
	do{
		...
		/*输入获取时间*/	
		Key_Input1((Set_Time_Info.St_x+j*(Set_Time_Info.Weight+Set_Time_Info.Jx_x)),			//x1
							 (Set_Time_Info.St_y+i*(Set_Time_Info.Hight+Set_Time_Info.Jx_y)), 			//y1
							 (Set_Time_Info.St_x+j*(Set_Time_Info.Weight+Set_Time_Info.Jx_x)+Set_Time_Info.Weight),	//x2
							 (Set_Time_Info.St_y+i*(Set_Time_Info.Hight+Set_Time_Info.Jx_y)+Set_Time_Info.Hight),		//y2
								key,4,date_time[j+i*Set_Time_Info.tls_x]);
